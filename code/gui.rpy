...
init python:
    ...
    config.main_menu_music = "/audio/YEEEBOI.mp3"  #don't forget to change the pathing for the file.
...
define gui.main_menu_background = "gui/main_menu_filler.png"
define gui.game_menu_background = "gui/game_menu_filler.png"
